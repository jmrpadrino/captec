<?php get_header(); ?>
            <section class="hero-divider">
				<div class="background-image-holder parallax-background overlay">
					<img class="background-image" alt="Poster Image For Mobiles" src="<?php echo get_template_directory_uri() . '/images/terminal-credit-card.jpg'; ?>">
				</div>
				
				<div class="container">
					<div class="row">	
						<div class="col-md-8 col-md-offset-2 col-sm-10 col-sm-offset-1 text-center">
							<h1 class="text-white vis vis-up"><?php _e('Clientes de Captec S.A.','captec'); ?></h1>
							<p class="lead text-white">
							    <?php _e('As&iacute; como usted, ellos tambien creyeron en los <strong>productos y servicios de Captec S.A.</strong><br /> Adelante, s&iacute;rvase de conocerlos','captec'); ?>
							</p>
						</div>
					</div><!--end of row-->
				</div><!--end of row-->
						...
						<li class="clearfix active">
							<div class="row">
								<div class="col-sm-8 col-sm-offset-2 text-center">
								    <h2>Texto SEO para posicionamiento de los clientes de Captec S.A.</h2>	
								</div>
							</div><!--end of row-->
