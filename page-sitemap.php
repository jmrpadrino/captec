				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<span class="text-white alt-font"><?php _e('Captec S.A. a un clic','captec'); ?></span>
		    ...
		    <div class="container">
		        <div class="row">
		            <div class="col-xs-12 text-center">
		                <h2><?php _e('Est&aacute; a un clic de la informaci&oacute;n que Captec S.A., tiene para usted. <br/> <strong>Bienvenido</strong>','captec'); ?></h2>
		            </div>
		        </div>
		    </div>
		</section>
