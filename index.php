			...
			<section class="side-image clearfix">
				<div class="container">
					<div class="row">
						<div class="col-md-6 col-sm-12 content clearfix">
							<h1 class="space-bottom-medium">Personalización de tarjeta magnética para CPN.</h1>
							<p class="lead space-bottom-medium">
								Este es un párrafo para explicar brevemente el servicio prestado a esta empresa. este espacio funciona aleatoriamente mostrando además información en video o imágen relacionada con el servicio.
							</p>
							<a href="#" class="btn btn-primary"><?php _e('Ver servicio','captec'); ?></a>
				...
				<div class="image-container col-md-5 col-sm-4 pull-right">
                    <div class="background-image-holder">
                        <img class="background-image" alt="Background Image" src="<?php echo get_template_directory_uri(); ?>/images/HOPE-Blog-Post-Image.jpg">
                    </div>
                </div>
			</section>
